        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div className="relative w-24 h-24 rounded-full bg-foreground/10 backdrop-blur-sm flex items-center justify-center cursor-pointer group">
                  <motion.div
                  ...
                  />
                  <Play className="w-10 h-10 text-foreground relative z-10 ml-1 group-hover:scale-110 transition-transform" />
                </div>
              </motion.div>
